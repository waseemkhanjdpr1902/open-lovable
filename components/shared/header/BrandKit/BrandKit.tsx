...
export default function HeaderBrandKit() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex size-28 items-center justify-center rounded-8 bg-accent-black text-sm font-bold text-white">
          C
        </span>
        <span className="text-lg font-semibold tracking-tight text-accent-black">Codely</span>
      </Link>
